...
We started tracking player searches on Fortnite Ping in mid October 2019. As of now, `r player_count` players have been searched in more than `r search_count` searches. Here is the breakdown of searches by region. The relatively large number of searches in NA East may be due to the it being used to organize scrims.
...
#raw_data
#dbGetQuery(con, paste0("SELECT * FROM PlayerSearchView"))
```