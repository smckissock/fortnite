...
--	, CONVERT(nvarchar(100), W1Rank)  + '  ' +  
--		CONVERT(nvarchar(100), W2Rank) + '  ' + 
--		CONVERT(nvarchar(100), W3Rank) + '  ' + 
...
CREATE OR ALTER  VIEW [dbo].[SquadPlayerView]
AS
...
JOIN Squad s ON s.ID = sp.SquadID
GO
...
SELECT
	...
	,	(ISNULL(CONVERT(DECIMAL(10, 1), w1.Rank), 500) + 
		ISNULL(w2.Rank, 500) + 
		ISNULL(w3.Rank, 500) + 
		ISNULL(w4.Rank, 500)) / 4 AverageRank
